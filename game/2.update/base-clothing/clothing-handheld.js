...
function initHandheld() {
	...
	const clothing = [
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 4000,
			description: "비를 막기 위해 코팅 처리되었습니다.",
			shop: ["clothing"],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 4000,
			description: "학교 교과서를 넣고 다니기 좋습니다.",
			shop: ["clothing"],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 4000,
			description: "운동용 양말 냄새가 배는 걸 신경 쓰지 않는다면, 학교 교과서를 넣고 다니기 좋습니다.",
			shop: ["clothing"],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: [
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 3000,
			description: "비는 막아주지만, 햇빛은 막지 못합니다.",
			shop: ["clothing"],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: [],
