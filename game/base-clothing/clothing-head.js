...
function initHead() {
	...
	const clothing = [
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 3000,
			description: "머리띠에 달린 귀여운 토끼 귀입니다. 바니걸 의상의 일부입니다.",
			shop: ["adult"],
			accessory: 1,
			accessory_colour: 0,
		...
		new ClothesItem({
			...
			warmth: 1,
			cost: 5000,
			description: "머리카락에 크림이 묻지 않게 해줍니다.",
			shop: ["forest"],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: ["black", "blue", "brown", "green", "pink", "purple", "red", "tangerine", "teal", "white", "yellow", "custom"],
		...
		new ClothesItem({
			...
			warmth: 2,
			cost: 8000,
			description: "순응하는 것은 당신의 스타일이 아닙니다.",
			shop: ["clothing"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 1100,
			description: "머리카락을 뒤로 넘겨 고정해 줍니다.",
		...
		new ClothesItem({
			...
			warmth: 1,
			cost: 1200,
			description: "청소할 때 귀엽게 보이도록 해줍니다.",
			shop: ["clothing", "adult"],
			shopGroup: "maidband",
			accessory: 0,
			accessory_colour: 0,
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 1100,
			description: "머리카락이 눈을 가리지 않게 해줍니다.",
			shop: ["clothing"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 2,
			cost: 2200,
			description: "자랑스러워할 일이 있을 때 착용합니다.",
			shop: ["clothing", "adult"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 3,
			cost: 2000,
			description: "보호용 모자입니다. 외국의 스포츠에서 사용됩니다.",
			shop: ["clothing", "school", "adult"],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: ["black", "blue", "brown", "green", "pink", "purple", "red", "tangerine", "teal", "white", "yellow", "custom"],
		...
		new ClothesItem({
			...
			warmth: 1,
			cost: 4500,
			description: "정직한 남자들과 아름다운 아가씨들을 위한 모자입니다.",
			shop: ["clothing"],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: ["black", "blue", "brown", "green", "pink", "purple", "red", "tangerine", "teal", "white", "yellow", "custom"],
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 3000,
			description: "머리띠에 달린 귀여운 토끼 귀 장식 두 개입니다.",
			shop: ["clothing"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 100,
			description: "머리카락 사이로 줄기를 엮을 수 있는 데이지 한 송이입니다.",
			shop: ["forest"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 2500,
			description: "잭오랜턴의 매력을 모두 담고 있으면서도 썩지 않습니다.",
			shop: ["forest"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 1500,
			description: "빛을 받아 반짝이는 효과를 냅니다.",
			shop: ["clothing"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 1,
			cost: 5000,
			description: "뒹굴고 더러워질 때 얼굴을 깨끗하게 유지해주지 않습니다.",
			shop: ["forest", "adult"],
			shopGroup: "nunlewd",
			accessory: 0,
			accessory_colour: 0,
		...
		new ClothesItem({
			...
			warmth: 2,
			cost: 500,
			description: "가난하고 작은 거리의 부랑아들을 위한 모자입니다.",
			shop: ["clothing"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 500,
			description: "소중한 누군가로부터 받은 선물입니다.",
			shop: [],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 1,
			cost: 4000,
			description: "잔해 속에 남겨져 있었습니다. 날아오는 콘크리트 조각을 막지는 못했습니다.",
			shop: ["forest"],
			accessory: 1,
			accessory_colour: 0,
		...
		new ClothesItem({
			...
			warmth: 2,
			cost: 2500,
			description: "원치 않는 시선으로부터 머리카락과 뒷모습을 보호해 줍니다.",
			shop: ["forest", "temple"],
			shopGroup: "nun",
			accessory: 0,
			accessory_colour: 0,
		...
		new ClothesItem({
			...
			warmth: 2,
			cost: 2500,
			description: "원치 않는 시선으로부터 머리카락을 보호해 줍니다.",
			shop: ["forest", "temple"],
			shopGroup: "nun",
			accessory: 0,
			accessory_colour: 0,
		...
		new ClothesItem({
			...
			warmth: 2,
			cost: 33300,
			description: "튼튼한 잎사귀로 덮여 있어 모자 자체가 살아있는 것처럼 느껴집니다. 아마도 당신보다 나이가 많을 것입니다. 비 온 뒤의 흙내음이 납니다.",
			shop: ["forest"],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			description: "즙이 많아 보이지만, 먹을 수는 없습니다.",
			cost: 2500,
			shop: ["clothing"],
			type: ["normal"],
			state: 0,
		...
		new ClothesItem({
			...
			description: "아주 작은 토끼 모양 헤어핀입니다.",
			cost: 2500,
			shop: ["clothing"],
			type: ["normal"],
			state: 0,
		...
		new ClothesItem({
			...
			description: "이것을 발견하면 버그로 신고하세요.",
			state: 0,
			state_base: 0,
			integrity: 200,
			integrity_max: 200,
		...
		new ClothesItem({
			...
			description: "학교에서 평판이 더 빨리 상승한다.",
			warmth: 3,
			cost: 3000,
			gender: "n",
			combat: {
