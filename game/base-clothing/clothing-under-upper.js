...
function initUnderUpper() {
	...
	const clothing = [
		...
		new ClothesItem({
			...
			warmth: 2,
			cost: 3000,
			description: "몸에 딱 맞는 핏입니다. 상체는 가려주지만, 공공장소에서는 반바지를 입는 편이 좋을 것 같습니다.",
			shop: ["clothing", "adult"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 4,
			cost: 3500,
			description: "몸에 딱 맞습니다. 다리를 가려줍니다.",
			shop: ["clothing", "adult"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 2,
			cost: 2500,
			description: "몸에 딱 붙습니다. 상체를 가려주지만, 허벅지와 그 이상을 드러냅니다.",
			shop: ["clothing", "adult"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 3,
			cost: 2500,
			description: "이 지역 학교의 공식 수영복이지만, 외국에서 유행하는 스타일입니다.",
			shop: ["clothing", "school"],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 2,
			cost: 5000,
			description: "웨이트리스 복장입니다. 보기보다 튼튼합니다. 바니걸 의상의 일부이며, 뒤에 달린 푹신한 흰 꼬리가 그 증거입니다.",
			shop: ["adult"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 1,
			cost: 3000,
			description: "평범한 브라로는 충분히 귀엽지 않을 때를 위한 것입니다.",
			shop: ["clothing", "adult"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 1,
			cost: 1000,
			description: "그 아래에 무엇이 있는지 암시합니다.",
			shop: ["clothing", "adult"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 2000,
			description: "노출이 심한 수영복입니다. 가슴이 큰 사람에게는 어울리지 않습니다.",
			shop: ["clothing"],
			shopGroup: "bikinitop",
			accessory: 0,
			accessory_colour: 0,
		...
		new ClothesItem({
			...
			warmth: 3,
			cost: 2500,
			description: "단정한 학교 수영복입니다. 빈티지 스타일입니다.",
			shop: ["clothing"],
			shopGroup: "schoolswimsuit",
			accessory: 0,
			accessory_colour: 0,
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 10000,
			description: "밧줄 플레이를 즐기는 사람들을 위한 것입니다.",
			shop: ["adult"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 2,
			cost: 3500,
			description: "몸에 딱 붙습니다. 상체를 가려주지만, 허벅지를 드러냅니다.",
			shop: ["clothing", "adult"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		new ClothesItem({
			...
			warmth: 0,
			cost: 1000,
			description: "선물이 무엇인지 추측할 필요가 없습니다.",
			shop: ["forest"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
